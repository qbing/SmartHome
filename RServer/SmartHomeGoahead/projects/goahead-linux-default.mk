...
LDFLAGS            += '-rdynamic'  '-Wl,-rpath,$$ORIGIN/'
...
$(CONFIG)/obj/goahead_shp.o: \
    src/goahead_shp.c $(DEPS_32)
	@echo '   [Compile] $(CONFIG)/obj/goahead_shp.o'
	$(CC) -c -o $(CONFIG)/obj/goahead_shp.o $(CFLAGS) $(DFLAGS) "$(IFLAGS)" "-I$(BIT_PACK_MATRIXSSL_PATH)" "-I$(BIT_PACK_MATRIXSSL_PATH)/matrixssl" "-I$(BIT_PACK_NANOSSL_PATH)/src" "-I$(BIT_PACK_OPENSSL_PATH)/include" src/goahead_shp.c
...
DEPS_33 += $(CONFIG)/obj/goahead_shp.o
...
$(CONFIG)/bin/goahead: $(DEPS_33)
	...
	$(CC) -o $(CONFIG)/bin/goahead $(LDFLAGS) $(LIBPATHS)    "$(CONFIG)/obj/goahead.o" "$(CONFIG)/obj/goahead_shp.o" $(LIBPATHS_33) $(LIBS_33) $(LIBS_33) $(LIBS) $(LIBS) 
...
installBinary: $(DEPS_39)
	...
	ln -s "3.1.2" "$(BIT_APP_PREFIX)/latest"
	...
	cp $(CONFIG)/bin/libgo.a $(BIT_VAPP_PREFIX)/bin/libgo.a
ifeq ($(BIT_PACK_EST),1)
